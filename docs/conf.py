...
# -*- coding: utf-8 -*-
#
# Kamino documentation build configuration file, created by
# sphinx-quickstart on Thu Jan 30 16:58:22 2020.
#
...
man_pages = [
    (master_doc, 'prospector', 'Prospector Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'prospector', 'Prospector Documentation',
     author, 'prospector', 'One line description of project.',
     'Miscellaneous'),
]
